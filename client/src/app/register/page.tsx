...
export default function Register() {
  ...
  return (
    <form onSubmit={submit} className="max-w-md mx-auto mt-20 bg-zinc-900 p-6 rounded">
      ...
      <input className="w-full mb-2 bg-black border border-zinc-700 rounded p-2" placeholder="Nome" value={name} onChange={(e) => setName(e.target.value)} />
      ...
      <button className="w-full bg-green-500 text-black rounded p-2 font-semibold">Criar conta</button>
    </form>
  );
}
